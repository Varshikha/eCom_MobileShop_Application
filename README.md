<p align="center">
<img src="src/frontend/static/icons/Hipster_HeroLogoCyan.svg" width="300" alt="Online Mobile" />
</p>
...
**Online Mobile** is a cloud-native microservices demo application.
Online Boutique consists of a 10-tier microservices application. The application is a
web-based e-commerce app where users can browse items,
add them to the cart, and purchase them.

**OS3 uses this application to demonstrate use of technologies like
...
**Online Mobile** is composed of 11 microservices written in different
